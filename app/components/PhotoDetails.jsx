...
import { getDictionary } from "../[lang]/disctionaries"
                    ...
                    <div className="mt-6">
                        <div className="flex justify-between items-center mb-3">
                            <div className="flex items-center gap-3">
                                <Image className="size-12 lg:size-14 rounded-full border" src={photo.author.avatar} alt={photo.author.name} height={100} width={100} />
                            ...
                            <button className="flex items-center gap-1.5 text-black/60 text-xs xl:text-sm">
                                <Image src="/follow.svg" className="w-5 h-5" width={5} height={5} alt="follow" />
                                {dict.follow}
                            </button>
                        </div>
                    ...
                    <div className="mt-6">
                        <div className="flex items-stretch gap-3">
                            <button
                                ...
                                <Image src="/heart.svg" className="w-5 h-5" height={5} width={5} alt="heart" />
                                {photo.likes}
                            </button>
                            <button
                                className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
                                <Image src="/save.svg" className="w-5 h-5" height={5} width={5} alt="save" />
                                {dict.save}
                            </button>
                            <button
                                className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
                                <Image src="/share.svg" className="w-5 h-5" height={5} width={5} alt="share" />
